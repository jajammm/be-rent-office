...
use App\Http\Requests\StoreCheckBookingTransactionRequest;
...
class BookingTransactionController extends Controller
{
    ...
    public function booking_details(StoreCheckBookingTransactionRequest $request)
    {
       $request->validated(StoreCheckBookingTransactionRequest::class);
